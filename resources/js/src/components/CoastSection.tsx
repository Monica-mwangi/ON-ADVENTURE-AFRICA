...
const CoastSection = () => {
  ...
  return (
    <section
      className="w-full px-6 py-16  text-gray-800"
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {features.map((feature, index) => (
          <div key={index} className="flex flex-col items-start bg-gray-100 p-6 rounded-lg shadow hover:shadow-md transition">
